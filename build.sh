...
pandoc --pdf-engine=lualatex --highlight-style ./.config/custom.theme --toc --toc-depth=3 -V date=$(date +%d/%m/%Y%n) -F pandoc-crossref ../.build/tmp.md -o "../dist/Apostila JavaScript ES6+ - Prof. Fausto Cintra.pdf"
